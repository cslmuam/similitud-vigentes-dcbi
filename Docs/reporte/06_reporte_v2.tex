...
1\,597 UEAs, 1\,210~aristas de seriación estructurales (Tabla~\ref{tab:grafos}),
498 evaluadas individualmente para impacto marginal sobre~$\ETtit$,
...
2\,132~UEAs en el banco de datos (688~en el grafo unificado CBI), 1\,210~aristas de
seriación estructurales de las cuales 498~fueron evaluadas individualmente
para impacto marginal (las~712~restantes presentan impacto negligible en el modelo),
...
\caption{Estadísticas de los grafos de seriación por plan.
         ...
         El total de~1\,210 aristas de seriación es la suma por plan; aristas
...
El conteo de la Tabla~\ref{tab:grafos} es por plan, de modo que el total divisional de 1\,210 seriaciones y 249 corregistros es la suma de los totales individuales y no el recuento de aristas únicas del grafo unificado.
De las 1\,210 seriaciones, 498 conectan pares de UEAs obligatorias y fueron evaluadas individualmente para impacto marginal sobre~$\ETtit$; las 712 restantes se excluyen del análisis de efecto (\S\ref{sec:efecto}).

La UEA de mayor alcance es Ecuaciones Diferenciales Ordinarias (\uea{1112030}):
18~aristas de salida y 260~descendientes, obligatoria en los diez planes.
...
En los nueve planes comparables, el error en la condición~(\ref{eq:calibracion})
es $|\Delta|\leq 0.89$~trim (menos de un trimestre); en seis de ellos
$|\Delta|\leq 0.48$~trim, y el promedio
ponderado de CBI es 20.71~trim frente a 20.62~trim oficiales.
...
\midrule
amb &  411 & 13.70 & 30.0 & 20.85 & 20.56 & $+0.29$ \\
civ &  394 & 13.13 & 30.0 & 21.01 & 20.34 & $+0.67$ \\
com &  406 & 12.69 & 32.0 & 20.31 & 20.31 & $+0.00$ \\
ele &  412 & 13.73 & 30.0 & 22.30 & 21.41 & $+0.89$ \\
elo &  408 & 13.60 & 30.0 & 23.72 & 23.24 & $+0.48$ \\
fis &  376 & 12.53 & 30.0 & 21.08 & 20.25 & $+0.83$ \\
ind &  405 & 13.06 & 31.0 & 19.80 & 19.40 & $+0.40$ \\
mec &  379 & 13.54 & 28.0 & 21.41 & 21.18 & $+0.23$ \\
met$^\dagger$ & 419 & 10.22 & 41.0 &
      \textit{16.73}$^{*}$ & 22.26 & --- \\
qui &  411 & 12.45 & 33.0 & 19.24 & 19.41 & $-0.18$ \\
\midrule
\textbf{CBI} & & & & \textbf{20.71} & \textbf{20.62} & $+0.09$ \\
\bottomrule
...
\caption{Calibración del modelo probabilístico de trayectorias estudiantiles.
  ...
  \textbf{El modelo reproduce el tiempo oficial de egreso con un error máximo
  menor a un trimestre en todos los planes comparables (véase tabla adjunta),
...
El valor $\ETtit^{\,\mathrm{mod}}=16.73$~trim es una cota inferior.
...
opera a $c_s\approx 28$--$33$~cr/trim ---entre el 62\% y el 73\% de la
...
Con la carga calibrada y una tasa neta de aprobación $\bar{a}\approx 0.630$--$0.726$,
los créditos aprobados acumulados en 12~trimestres son
\begin{equation}
  c_s\cdot\bar{a}\cdot 12 \;\approx\; 222\text{--}278\;\text{cr},
  \label{eq:acum_12}
\end{equation}
...
\midrule
amb &  30 & 0.726 & 411 &  8 &  9 & \textbf{19} & carga \\
civ &  30 & 0.662 & 394 &  7 &  8 & \textbf{20} & carga \\
com &  32 & 0.630 & 406 &  9 & 10 & \textbf{21} & carga \\
ele &  30 & 0.673 & 412 &  8 &  9 & \textbf{21} & carga \\
elo &  30 & 0.653 & 408 &  9 & 10 & \textbf{21} & carga \\
fis &  30 & 0.653 & 376 &  7 &  8 & \textbf{20} & carga \\
ind &  31 & 0.717 & 405 &  5 &  6 & \textbf{19} & carga \\
mec &  28 & 0.661 & 379 &  8 &  9 & \textbf{21} & carga \\
met &  41 & 0.710 & 419 &  8 &  9 & \textbf{15} & carga \\
qui &  33 & 0.702 & 411 &  8 &  9 & \textbf{18} & carga \\
\bottomrule
\end{tabular}
\end{table}
...
Cuando se eliminan \emph{todas} las codependencias (seriaciones y
corregistros), $\ET{12}$ sube de 0\% a \textbf{7.9\%}.
...
el tiempo de egreso lo suficiente para que un~7.9\% alcance los 12~trimestres.
...
Metalurgia confirma la excepción: sin codependencias, $\ET{12} = 7.9\,\text{\%}$
...
\midrule
1112029 & Cálculo Integral                            & 0.55 & 366 & 0.42 & 2.2\% & D+I \\
1111081 & Dinámica del Cuerpo Rígido                  & 0.66 & 305 & 0.39 & 0.7\% & PD  \\
1112043 & Cálculo Diferencial                         & 0.48 & 448 & 0.47 & 4.3\% & D+I \\
1112030 & Ecuaciones Diferenciales Ordinarias         & 0.57 & 260 & 0.37 & 1.4\% & D+I \\
1111079 & Cinemática y Dinámica de Partículas         & 0.57 & 307 & 0.38 & 1.9\% & D+I \\
1112013 & Complementos de Matemáticas                & 0.54 & 230 & 0.39 & 2.2\% & D+I \\
1145054 & Ingeniería de los Materiales                & 0.64 &  75 & 0.32 & 1.0\% & PD  \\
1113046 & Termodinámica                               & 0.71 & 164 & 0.31 & 0.5\% & PD  \\
1142006 & Mecánica de Sólidos~I                       & 0.53 &  53 & 0.44 & 0.9\% & D+I \\
1111083 & Intro.\ Electrostática y Magnetostática     & 0.64 &  80 & 0.34 & 0.8\% & PD  \\
\bottomrule
\end{tabular}
\end{table}
...
($a_i = 0.48$--$0.57$), obligatorias en los diez planes, cientos de UEAs
...
Cinco planes (Ambiental, Civil, Computación, Física y Mecánica) presentan
además tramos no-monótonos donde
...
\midrule
Electrónica    & 53 & MM  & 1.99 & 1.0  & 2.04 & \phantom{0}8 (15\%) & 0.51 \\
Metalurgia     & 50 & Exp & ---  & ---  & 1.74 & 20 (40\%) & 0.61 \\
Química        & 54 & MM  & 0.60 & 0.0  & 1.33 & \phantom{0}5 (\phantom{0}9\%) & 0.37 \\
Ambiental      & 49 & Exp & ---  & ---  & 0.88 & \phantom{0}3 (\phantom{0}6\%) & 0.56 \\
Eléctrica      & 48 & MM  & 0.86 & 5.6  & 0.83 & 14 (29\%) & 0.43 \\
Mecánica       & 49 & MM  & 0.26 & 0.0  & 0.59 & 49 (100\%) & 0.32 \\
Industrial     & 51 & MM  & 0.38 & 0.3  & 0.58 & 26 (51\%) & 0.29 \\
Computación    & 51 & MM  & 0.38 & 0.4  & 0.56 & 51 (100\%) & 0.24 \\
Física         & 46 & Exp & ---  & ---  & 0.46 & 46 (100\%) & 0.42 \\
Civil          & 47 & Exp & ---  & ---  & 0.36 & \phantom{0}2 (\phantom{0}4\%) & 1.23 \\
\bottomrule
\end{tabular}
\end{table}
...
\begin{itemize}[leftmargin=2em]
\item \textbf{Electrónica}, \textbf{Química} y \textbf{Ambiental}:
  $N_{80} = 8$, $5$ y $3$~aristas
  (15\%, 9\% y 6\% del total del plan).
  Pocas aristas concentran el 80\% del beneficio máximo --- estructura
  Pareto pronunciada, candidatos a reforma quirúrgica.
\item \textbf{Mecánica}, \textbf{Computación} y \textbf{Física}:
  $N_{80} = n_{\mathrm{ser}}$ (100\% del total).
  El beneficio se distribuye de forma aproximadamente uniforme entre todas sus
  seriaciones; ninguna arista individual domina.
\item \textbf{Civil}: $N_{80} = 2$~aristas (4\%), con
  $G_{\max}^{\mathrm{obs}} = 0.36$~trim.
  ...
  en Civil es la carga crediticia histórica, no las seriaciones.
\end{itemize}
...
entre~$0.24$ y~$1.23$ entre planes sin que la sola inspección de la
Tabla~\ref{tab:dosis_respuesta} revele qué estructura topológica determina
si una reforma conjunta será muy subaaditiva ($\mathcal{A}\approx0.24$) o
incluso superaditiva ($\mathcal{A}\approx1.23$).
...
combinada positiva y ratio acotado (110~puntos de los 120 totales; los restantes
corresponden a tramos no-monótonos donde el ratio es inestable).
El ajuste arroja $R^2=0.09$:
el único predictor significativo es~$f_{\mathrm{dst}}$ ($t=3.09$, positivo,
las aristas que convergen al mismo destino interfieren menos entre sí);
ningún otro predictor topológico alcanza significancia al 5\,\text{\%}.
...
\caption{Modelo predictivo del índice de aditividad~$\mathcal{A}(N)=G(N)/\sum_{i=1}^{N}\Delta\ETtit_i$,
  ...
  con cinco predictores topológicos del subconjunto; varianza explicada~$R^2=0.09$,
  color por plan.
...
\textbf{Metalurgia.}
El valor $\ETtit=16.73$~trim para Metalurgia es una cota inferior.
...
en~12~trimestres ($\mathrm{ET}(12)=7.9\,\text{\%}$).
